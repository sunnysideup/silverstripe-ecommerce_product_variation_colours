...
class ColourDropdownField extends DropdownField
{
    ...
    public static function get_js_location_for_select_styling()
    {
        return self::$js_location_for_select_styling;
    }
    public static function set_js_location_for_select_styling($s)
    {
        self::$js_location_for_select_styling = $b;
    }
