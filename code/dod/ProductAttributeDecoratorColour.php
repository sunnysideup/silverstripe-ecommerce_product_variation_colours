...
class ProductAttributeDecoratorColour_Value extends DataObjectDecorator
{
    ...
    public static function get_default_colour()
    {
        return self::$default_colour;
    }
    public static function set_default_colour($s)
    {
        self::$default_colour = $s;
    }
    ...
    public static function get_default_contrast_colour()
    {
        return self::$default_contrast_colour;
    }
    public static function set_default_contrast_colour($s)
    {
        self::$default_contrast_colour = $s;
    }
    ...
    public static function get_put_styling_in_dropdown_options()
    {
        return self::$put_styling_in_dropdown_options;
    }
    public static function set_put_styling_in_dropdown_options($b)
    {
    ...
    public function ComputedRGBCode()
    {
    ...
    public function ComputedContrastRGBCode()
    {
    ...
    public function updateValueForDropdown(&$v, $forceUpdate = false)
    {
...
class ProductAttributeDecoratorColour_Type extends DataObjectDecorator
{
    ...
    public function updateDropDownField(&$field)
    {
